        ...
        "manual_malls": [
            {
                ...
                "floors": ["1F", "2F", "3F"],
                "note": "香川県高松市三条町608-1。OSM 無建物輪廓，範圍為依實際建物規模估算的示意方框"
                        "（約 300×150m，本館＋南館＋東館三棟相連的賣場量體，"
                        "不含周邊平面停車場；敷地面積約 98,530㎡、店舗面積約 54,590㎡，"
                        "ja.wikipedia.org 查證），非精確外觀。放大縮小時範圍也更容易點到（而非誤點到店家標記）。",
                "box_m": [150, 75],
            },
            {
                ...
                "floors": ["1F", "2F"],
                "note": "香川県丸亀市新田町150。OSM 無建物輪廓，範圍為依實際建物規模估算的示意方框"
                        "（約 145×95m，涵蓋 1-3F 賣場＋附設立體停車場量體；"
                        "敷地面積約 47,800㎡、店舗面積約 24,400㎡，ja.wikipedia.org 查證），非精確外觀。",
                "box_m": [73, 48],
            },
            {
